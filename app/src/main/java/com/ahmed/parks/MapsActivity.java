...
import com.ahmed.parks.fragments.DetailsFragment;
import com.ahmed.parks.fragments.ParksFragment;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stateCodeEditText = findViewById(R.id.floating_state_edit_text);
...
//                Log.i("TAG" , "onMapReady: " + park.getFullName());
            }
